...
class Sensor3700 extends ClientNode {
  constructor(lifetime, UUID, serverIP, clientPort, serverPort) {
    super(lifetime, '8devices', '8dev_3700', true, UUID, serverIP, clientPort, serverPort);
...
class Sensor3800 extends ClientNode {
  constructor(lifetime, UUID, serverIP, clientPort, serverPort) {
    super(lifetime, '8devices', '8dev_3800', true, UUID, serverIP, clientPort, serverPort);
...
class Sensor4400 extends ClientNode {
  constructor(lifetime, UUID, serverIP, clientPort, serverPort) {
    super(lifetime, '8devices', '8dev_4400', true, UUID, serverIP, clientPort, serverPort);
...
class Sensor4500 extends ClientNode {
  constructor(lifetime, UUID, serverIP, clientPort, serverPort) {
    super(lifetime, '8devices', '8dev_4500', true, UUID, serverIP, clientPort, serverPort);
